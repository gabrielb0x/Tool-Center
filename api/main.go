...
func setupRoutes(r *gin.Engine) {
	...
	usersGroup.GET("/:username", user.ProfileHandler)
	...
	adminGroup.GET("/users/:id/activity", admin.UserActivityHandler)
        ...
        adminGroup.GET("/users/:id/sanctions", admin.UserSanctionsHandler)
        ...
        adminGroup.GET("/appeals", admin.ListAppealsHandler)
        adminGroup.POST("/appeals/:id", admin.ReviewAppealHandler)
