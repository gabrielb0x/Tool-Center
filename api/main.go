...
func setupRoutes(r *gin.Engine) {
	...
	userGroup.GET("/verify_email", user.VerifyEmailHandler)
        ...
        userGroup.GET("/sanctions", user.MySanctionsHandler)
	...
	adminGroup.Use(utils.RequireRole("Admin"))
        ...
        adminGroup.POST("/sanctions/:id", admin.AddSanctionHandler)
        adminGroup.GET("/sanctions/:id", admin.ListSanctionsHandler)
