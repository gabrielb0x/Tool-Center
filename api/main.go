...
func setupRoutes(r *gin.Engine) {
	...
	userGroup.POST("/update_email", user.UpdateEmailHandler)
        ...
        userGroup.POST("/sanctions/:id/appeal", user.AppealSanctionHandler)
        userGroup.GET("/tickets", user.ListTicketsHandler)
        userGroup.POST("/tickets", user.CreateTicketHandler)
	...
	adminGroup.POST("/users/:id/ban", admin.BanUserHandler)
        ...
        adminGroup.GET("/sanctions", admin.ListSanctionsHandler)
        adminGroup.POST("/sanctions", admin.CreateSanctionHandler)
        adminGroup.GET("/tickets", admin.ListTicketsHandler)
